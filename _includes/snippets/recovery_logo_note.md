...
{%- capture content %}
If your recovery does **not** show the LineageOS Revived logo <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" style="height: 1rem; vertical-align: middle;" fill="currentColor">
