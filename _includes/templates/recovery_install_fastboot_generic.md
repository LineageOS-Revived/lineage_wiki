...
2. Your device utilizes retrofitted dynamic partitions (RDAP), so you'll also need to download the latest [super_empty.img](https://download.lineage.rgbroms.top/devices/{{ device.codename }}) file.
{%- endif %}
